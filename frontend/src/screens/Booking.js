                                ...
                                <div className="flex flex-col items-center">
                                    ...
                                    <div className="px-1 sm:px-3">
                                        ...
                                        <div className="ml-8 flex mb-4">
                                            ...
                                            <span className="font-mono">{room?.pricePerDay} LKR</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="flex flex-col items-center">
                                    <div className="px-1 sm:px-3">
                                        ...
                                        <div className="ml-8 flex mb-4">
                                             ...
                                             * have to check the payment gateway
                                             * 
                                             */}
                                            <span className="font-medium inline-block  w-28">Dates:</span>
                                            <button onClick={() => setIsDateOpen(true)}>
                                                <textarea value={dates?.toString()} disabled={isDateOpen} id="phone" rows={dates.length + 1} cols={10} className="py-2 px-1 sm:px-2 rounded-md border border-solid border-gray-400 text-gray-700 font-mono cursor-pointer break-all resize-none hover:bg-red-200 transition duration-200" />
                                            </button>
                                        ...
                                        <div className="ml-8 flex mb-4">
                                            ...
                                            <span className="font-mono">{prices} LKR</span>
                                        </div>
                                        <div className="ml-8 flex mb-4">
                                            <span className="font-medium inline-block  w-28">Vat:</span>
                                            <span className="font-mono">{vat} LKR</span>
                                        </div>
                                        <div className="ml-8 flex mb-4">
                                            <span className="font-medium inline-block w-28">Total Price:</span>
                                            <span className="font-mono">{totalPrice} LKR</span>
                                        </div>
                                    </div>
